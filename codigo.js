...
document.addEventListener("DOMContentLoaded", () => {
    const traducciones = {
        es: {
            ...
            footer_desc: "Especializado en el desarrollo de software y el testing. Comprometido con la estructura, las pruebas y la solidez de cada sistema.",
            footer_menu: "Menú",
        ...
        en: {
            ...
            footer_desc: "Specialized in software development and QA testing. Committed to structure, testing, and system reliability.",
            footer_menu: "Menu",
